select
    ...
    case when he.equipmentid is not null  then lpu2.Lic  end  as owner,
...
from lbr_LaboratoryResearch lr
         ...
         left join hlt_Equipment he on cast (he.equipmentid as varchar) + cast(he.InventoryNumber as varchar) = hcar.performerDeviceID
    cross apply (
 select
